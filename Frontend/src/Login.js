...
function Login(){  
  ...
  if(log===undefined)
  {
    ...
    //for rendering  Admin page
 
  if(role==='Admin'){navig('/admindashboard')}

  //for rendering  Owner page
 
  else if(role==='Owner'){navig('/ownerdashboard')}
 
  //for rendering user page
 
  else if(role==='User'){navig('/dashboard')}
